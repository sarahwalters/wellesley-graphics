var DEMO = {
	...
	initialize: function initialize(inIdCanvas, inParameters) {
		...
		// Create ship
		DEMO.shipWithSail = new SWALTER2_PROJECT.ShipWithSail();
		DEMO.shipWithSail.position.set(800, 0, -800);
		DEMO.shipWithSail.rotation.set(0, - Math.PI / 4, 0);
		this.ms_Scene.add(DEMO.shipWithSail);
	...
	update: function update() {
		...
		DEMO.shipWithSail.position.x = DEMO.shipWithSail.position.x - 1;
		DEMO.shipWithSail.position.z = DEMO.shipWithSail.position.z + 1;
